...
public class TestAccount {
    public static void main(String[] args) {
        try {
            ...
            ModifiedByInterface modTest1 = new ModifiedBy("Updated Account", "JBLOGGS", new Date());
            ...
            test1.createTransaction(tran1, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            
            System.out.println("\n" + test1.getBalance());
            System.out.println(test1.isNegativeInd());
            
            test1.createTransaction(tran2, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            test1.createTransaction(tran3, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            
            System.out.println("\n" + test1.getBalance());
            System.out.println(test1.isNegativeInd());
            
            test1.createTransaction(tran4, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            test1.createTransaction(tran5, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            test1.createTransaction(tran6, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            
            System.out.println("\n" + test1.getBalance());
            System.out.println(test1.isNegativeInd());
            
            test1.createTransaction(tran7, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            
            System.out.println("\n" + test1.getBalance());
            System.out.println(test1.isNegativeInd());
            
            test1.createTransaction(tran8, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            ...
            test1.deleteTransaction(3, new ModifiedBy("Deleted Transaction", "DEDWARDS", new Date()));
            System.out.println("\n" + test1.getBalance());
            
            test1.deleteTransaction(21, new ModifiedBy("Deleted Transaction", "DEDWARDS", new Date()));
            System.out.println(test1.getBalance());
            ...
            test1.createNote(note10, modTest1);
            test1.createNote(note11, modTest1);
            test1.createNote(note12, modTest1);
            
            System.out.println(test1.getNotes());
            
            test1.deleteNote(11, new ModifiedBy("Deleted Note", "DEDWARDS", new Date()));
            test1.deleteNote(1, new ModifiedBy("Deleted Note", "DEDWARDS", new Date()));  // This is a note for a transaction and therefore should not delete
            
            System.out.println(test1.getNotes());
            
            System.out.println("\n\n****** Creating Documents ******");
            
            Note note13 = new NoteImpl(8, "TEST", "DEDWARDS", new Date());
            Note note14 = new NoteImpl(9, "TEST", "DEDWARDS", new Date());
            
            
            Document document = new DocumentImpl(1, new File("TEST.pdf"), note13, "DEDWARDS", new Date());
            Document document2 = new DocumentImpl(2, new File("TEST.pdf"), note13, "DEDWARDS", new Date());
            
            test1.createDocument(document, new ModifiedBy("Created Document", "DEDWARDS", new Date()));
            test1.createDocument(document2, new ModifiedBy("Created Document", "DEDWARDS", new Date()));
            
            
            System.out.println("\n\n****** Ending Account ******");
            
            ModifiedByInterface modTest2 = new ModifiedBy("Ended Account", "JBLOGGS", new Date());
            ...
            test1.createTransaction(tran9, new ModifiedBy("Created Transaction", "JBLOGGS", new Date()));
            
            System.out.println("\n" + test1.getBalance());
            System.out.println(test1.isNegativeInd());
            
            ModifiedByInterface modTest3 = new ModifiedBy("Updating Account", "DEDWARDS", new Date());
            Date date3 = new Date();
            date3.setMonth(0);
            date3.setDate(3);
