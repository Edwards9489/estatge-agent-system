...
public class ContractPanel extends JPanel {
    ...
    private final ContractTableModel tableModel;
    private JPopupMenu popup;
    private StringListener actionListener;
    
    public ContractPanel(String text) {
        ...
        JMenuItem createItem = new JMenuItem("Create Contract");
        JMenuItem viewItem = new JMenuItem("View Contract");
        JMenuItem endItem = new JMenuItem("End Contract");
        JMenuItem updateItem = new JMenuItem("Update Contract");
        JMenuItem deleteItem = new JMenuItem("Delete Contract");
        JMenuItem refreshItem = new JMenuItem("Refresh Contracts");
    ...
    public void setData(List<ContractInterface> contacts) {
