...
public class EmpAccDetails extends JFrame {
    ...
    private void viewNote() {
        if (notePanel.getSelectedObjectRef() != null) {
            ...
            try {
                ...
                if (note != null) {
                    NoteDetails employeeAccDetails = new NoteDetails(client, note, "Employee Account", employeeAcc.getAccRef());
    ...
    private JMenuBar createMenuBar() {
        ...
        JMenuItem contractItem = new JMenuItem("Contract");
        JMenuItem officeItem = new JMenuItem("Office");
        
        linksMenu.add(contractItem);
        ...
        contractItem.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent ev) {
                try {
                    ContractInterface contract = employeeAcc.getContract();
                    if (contract != null) {
        ...
        officeItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ev) {
                try {
                    OfficeInterface office = client.getOffice(employeeAcc.getOfficeCode());
                    if (office != null) {
