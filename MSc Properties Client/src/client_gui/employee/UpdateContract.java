                    ...
                    if (correctInput) {
                        ...
                        try {
                            if (length > -1 && startDate != null) {
                                int answer = JOptionPane.showConfirmDialog(null, "Are you sure you would like to UPDATE contract " + contract.getAccountRef() + "?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
