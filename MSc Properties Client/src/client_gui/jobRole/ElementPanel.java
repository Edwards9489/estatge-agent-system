...
public class ElementPanel extends JPanel {
    ...
    public ElementPanel(String text) {
        ...
        JMenuItem addressItem = new JMenuItem("Requirements");
        ...
        addressItem.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(tableListener != null) {
                    String elementCode = (String) table.getModel().getValueAt(row, 0);
                    
                    System.out.println(elementCode);
                    tableListener.textOmitted(elementCode);
...
//                    System.out.println(row);
    ...
    public void setData(List<Element> requirements) {
        tableModel.setData(requirements);
    }
    ...
    public void setTableListener(StringListener tenListener) {
        this.tableListener = tenListener;
    }
    
    public String getSelectedObjectRef() {
        int row = table.getSelectedRow();
        if (row > -1) {
