...
public class LeasePanel extends JPanel {
    ...
    public LeasePanel(String text) {
        tableModel = new LeaseTableModel();
        ...
        JMenuItem createItem = new JMenuItem("Create Lease");
        JMenuItem viewItem = new JMenuItem("View Lease");
        JMenuItem endItem = new JMenuItem("End Lease");
        JMenuItem updateItem = new JMenuItem("Update Lease");
        JMenuItem deleteItem = new JMenuItem("Delete Lease");
        JMenuItem refreshItem = new JMenuItem("Refresh Leases");
    ...
    public void setData(List<LeaseInterface> leases) {
        tableModel.setData(leases);
    }
