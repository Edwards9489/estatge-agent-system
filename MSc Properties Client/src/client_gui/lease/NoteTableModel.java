...
public class NoteTableModel extends AbstractTableModel {
    ...
    private List<Note> db;
    
    private String[] colNames = {"Ref", "Note", "Created By", "Created Date", "Modified Last By", "Modified Last Date"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            ...
            switch(columnIndex) {
                ...
                case 3:
                    return new SimpleDateFormat("dd-MM-YYYY").format(note.getCreatedDate());
                case 4:
                ...
                case 5:
                    if(note.hasBeenModified()) {
                        return new SimpleDateFormat("dd-MM-YYYY").format(note.getLastModifiedDate());
                    } else {
                        return "";
                    }
            }
