 ...
 * @author Dwayne
 */
public class LeaseAccSearchPanel extends JPanel {
    ...
    public LeaseAccSearchPanel(ClientImpl client) {
        setClient(client);
        layoutComponents();
    }
    ...
    private void layoutComponents() {
        ...
        try {
            ...
            expenditureField = new JTextField(6);
            ...
            JLabel contractRef = new JLabel("Lease Ref    ");
            ...
            try {
                ...
                Logger.getLogger(LeaseAccSearchPanel.class.getName()).log(Level.SEVERE, null, ex);
            }

            if (srchImge != null) {
                ImageIcon icon = new ImageIcon(srchImge);
                leaseThumb.setIcon(icon);
            }

            leaseThumb.addMouseListener(new MouseAdapter() {
                @Override
                public void mousePressed(MouseEvent e) {
                    LeaseSearch leaseSearch = new LeaseSearch(client, new IntegerListener() {
                        @Override
                        public void intOmitted(int leaseRef) {
                            setLeaseRefField(leaseRef);
                        }
                    });
            ...
            gc.anchor = GridBagConstraints.WEST;
            gc.insets = new Insets(0, 0, 0, 5);
            detailsPanel.add(leaseThumb, gc);
    ...
    public void setLeaseRefField(int tenRef) {
