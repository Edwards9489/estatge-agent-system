...
public class TransactionTableModel extends AbstractTableModel {
    ...
    private List<TransactionInterface> db;
    
    private String[] colNames = {"Ref", "From Ref", "To Ref", "Amount", "Is Debit?", "Date"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            ...
            switch(columnIndex) {
                ...
                case 5:
                    return new SimpleDateFormat("dd-MM-YYYY").format(transaction.getTransactionDate());
            }
            return null;
