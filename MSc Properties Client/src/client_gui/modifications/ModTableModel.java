...
public class ModTableModel extends AbstractTableModel {
    ...
    private List<ModifiedByInterface> db = new ArrayList();
    
    private final String[] colNames = {"Modification", "Modified By", "Modified Date"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            ...
            switch(columnIndex) {
                ...
                case 2:
                    return formatter.format(modifiedBy.getModifiedDate());
            }
            return null;
