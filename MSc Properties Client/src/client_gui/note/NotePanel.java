...
public class NotePanel extends JPanel {
    ...
    public NotePanel(String text) {
        ...
        JMenuItem createItem = new JMenuItem("Create Note");
        JMenuItem viewItem = new JMenuItem("View Note");
        JMenuItem updateItem = new JMenuItem("Update Note");
        JMenuItem deleteItem = new JMenuItem("Delete Note");
        JMenuItem refreshItem = new JMenuItem("Refresh Notes");
