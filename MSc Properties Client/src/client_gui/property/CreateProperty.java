 ...
 * @author Dwayne
 */
public class CreateProperty extends JFrame {
    ...
    public CreateProperty(ClientImpl client) {
        setClient(client);
        layoutComponents();
    }
        ...
        try {
            ...
            okButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ev) {
                    int result = 0;
                    int answer = JOptionPane.showConfirmDialog(null, "Are you sure you would like to CREATE a new Property?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (answer == JOptionPane.YES_OPTION) {
                        ...
                        if (startDate != null && !propTypeCode.equals("  ---  ") && !propSubTypeCode.equals("  ---  ") && addrRef > 0) {
                            try {
                                ...
                                if (result > 0) {
                                    String message = "The new Property has been created and assigned Property Ref " + result;
                                    String title = "Information";
                                    OKDialog.okDialog(CreateProperty.this, message, title);
                                    setVisible(false);
                                    dispose();
                                } else {
                                    System.out.println("WITHIN IF STATEMENT 5");
                                    String message = "There is some errors with the information supplied to CREATE the new Property\nPlease check the information supplied";
                                    String title = "Error";
                                    OKDialog.okDialog(CreateProperty.this, message, title);
                                }
            ...
            Border titleBorder = BorderFactory.createTitledBorder("Create Property");
            ...
            dimension.setSize(dimension.getWidth() + 500, dimension.getHeight());
