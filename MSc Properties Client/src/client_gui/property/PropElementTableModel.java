...
public class PropElementTableModel extends AbstractTableModel {
    ...
    private List<PropertyElementInterface> db;
    
    private String[] colNames = {"Ref", "Element Code", "Value", "Start Date", "End Date"};
    ...
    public Object getValueAt(int rowIndex, int columnIndex) {
        try {
            ...
            switch(columnIndex) {
                ...
                case 3:
                    return new SimpleDateFormat("dd-MM-YYYY").format(transaction.getStartDate());
                case 4:
