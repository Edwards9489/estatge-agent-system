 ...
 * @author Dwayne
 */
public class PropSearch extends JFrame {
    
    private JLabel title;
    private ClientImpl client = null;
    
    public PropSearch(ClientImpl client) {
    ...
    private JMenuBar createMenuBar() {
        ...
        exitItem.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev) {
                ...
                int action = JOptionPane.showConfirmDialog(PropSearch.this,
                ...
                if (action == JOptionPane.OK_OPTION) {
                    if (client != null) {
                        try {
                            ...
                            Logger.getLogger(PropSearch.class.getName()).log(Level.SEVERE, null, ex);
                        }
                    }
                    System.exit(0);
                }
