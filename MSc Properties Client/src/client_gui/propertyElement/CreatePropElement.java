 ...
 * @author Dwayne
 */
public class CreatePropElement extends JFrame {
    ...
    public CreatePropElement(ClientImpl client, int ref) {
        setClient(client);
        this.ref = ref;
        layoutComponents();
    }
    ...
    private void layoutComponents() {
        try {
            ...
            PropertyInterface property = client.getProperty(ref);
            ...
            try {
                for (Element propElement : client.getCurrentPropElements()) {
                    if (!property.hasPropElement(propElement.getCode())) {
                        elementField.addItem(propElement.getCode());
                    }
                }
            } catch (RemoteException ex) {
                Logger.getLogger(CreatePropElement.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            okButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ev) {
                    int result = 0;
                    int answer = JOptionPane.showConfirmDialog(null, "Are you sure you would like to CREATE a new Property Element with code " + elementField.getSelectedItem() + " for Property " + ref + "?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    if (answer == JOptionPane.YES_OPTION) {
                        ...
                        if (elementCode != null && !elementCode.equals("  ---  ") && startDate != null && (stringValue != null || doubleValue != 0.0)) {
                            try {
                                ...
                                if (result > 0) {
                                    String message = "The new Element for Property " + ref + " has been created and assigned Property Element Ref " + result;
                                    String title = "Information";
                                    OKDialog.okDialog(CreatePropElement.this, message, title);
                                    setVisible(false);
                                    dispose();
                                } else {
            ...
            Border titleBorder = BorderFactory.createTitledBorder("Create Property Element");
