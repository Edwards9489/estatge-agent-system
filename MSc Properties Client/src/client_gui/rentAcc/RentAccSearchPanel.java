 ...
 * @author Dwayne
 */
public class RentAccSearchPanel extends JPanel {
    ...
    public RentAccSearchPanel(ClientImpl client) {
        setClient(client);
        layoutComponents();
    }
    ...
    private void layoutComponents() {
        ...
        try {
            ...
            Border titleBorder = BorderFactory.createTitledBorder("Rent Account Search Details");
            ...
            JLabel contractRef = new JLabel("Tenancy Ref    ");
            ...
            Image srchImge = null;
            JLabel tenancyThumb = new JLabel();
            ...
            if (srchImge != null) {
                ...
                tenancyThumb.setIcon(icon);
            }

            tenancyThumb.addMouseListener(new MouseAdapter() {
                @Override
                public void mousePressed(MouseEvent e) {
                    TenSearch tenSearch = new TenSearch(client, new IntegerListener() {
                        @Override
                        public void intOmitted(int tenRef) {
                            setTenancyRefField(tenRef);
                        }
                    });
            ...
            gc.anchor = GridBagConstraints.WEST;
            gc.insets = new Insets(0, 0, 0, 5);
            detailsPanel.add(tenancyThumb, gc);
            ...
            JLabel appRefLabel = new JLabel("Rent    ");
            ...
            rentField.setFont(plainFont);
            
            gc.gridx++;
            gc.anchor = GridBagConstraints.WEST;
            gc.insets = new Insets(0, 0, 0, 5);
            detailsPanel.add(rentField, gc);
    ...
    public void setTenancyRefField(int tenRef) {
