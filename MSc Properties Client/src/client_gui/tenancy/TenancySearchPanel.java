 ...
 * @author Dwayne
 */
public class TenancySearchPanel extends JPanel {
    ...
    public TenancySearchPanel(ClientImpl client) {
        setClient(client);
        layoutComponents();
    }
        ...
        try {
            ...
            searchButton.addActionListener(new ActionListener() {
                ...
                public void actionPerformed(ActionEvent ev) {
                    ...
                    System.out.println("Ten Type: " + tenType);
            ...
            Border titleBorder = BorderFactory.createTitledBorder("Tenancy Search Details");
            ...
            try {
                ...
                Logger.getLogger(TenancySearchPanel.class.getName()).log(Level.SEVERE, null, ex);
            }
            ...
            JLabel appRefLabel = new JLabel("App Ref    ");
            ...
            gc.anchor = GridBagConstraints.WEST;
            gc.insets = new Insets(0, 0, 0, 5);
            detailsPanel.add(appRefField, gc);
            ...
            JLabel surname = new JLabel("Tenancy Type    ");
            ...
            gc.anchor = GridBagConstraints.WEST;
            gc.insets = new Insets(0, 0, 0, 5);
            detailsPanel.add(tenTypeField, gc);
