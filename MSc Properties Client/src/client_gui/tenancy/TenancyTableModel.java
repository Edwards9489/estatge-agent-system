...
public class TenancyTableModel extends AbstractTableModel {
    ...
    private List<TenancyInterface> db = new ArrayList();
    
    private final String[] colNames = {"Ref", "Name", "Start Date", "Actual End Date", "Rent", "Charges", "App Ref", "Office Code", "Account Ref"};
