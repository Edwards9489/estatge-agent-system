...
public interface Server extends Remote {
    ...
    int updatePersonDocument(int pRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int createOffice(String officeCode, int addrRef, Double addrLong, Double addrLat, Date startDate, String createdBy) throws RemoteException;
    ...
    int updateOfficeDocument(String oCode, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateApplicationDocument(int aRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updatePropertyDocument(int pRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateTenancyDocument(int tRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateLeaseDocument(int lRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateContractDocument(int cRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateRentAccDocument(int rRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateLeaseAccDocument(int lRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateEmployeeAccDocument(int eRef, int dRef, String fileName, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    String generateReport(Date startDate, Date endDate) throws RemoteException;
