...
public interface Server extends Remote {
    ...
    int updatePersonDocument(int pRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateOfficeDocument(String oCode, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateApplicationDocument(int aRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updatePropertyDocument(int pRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateTenancyDocument(int tRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateLeaseDocument(int lRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateContractDocument(int cRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateRentAccDocument(int rRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateLeaseAccDocument(int lRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
    ...
    int updateEmployeeAccDocument(int eRef, int dRef, byte[] buffer, String comment, String modifiedBy) throws RemoteException;
