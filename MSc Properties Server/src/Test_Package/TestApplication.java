...
public class TestApplication {
    public static void main(String[] args) {
        try {
            ...
            Note note6 = new NoteImpl(2, "TEST", "DEDWARDS", new Date());
            Note note7 = new NoteImpl(3, "TEST", "DEDWARDS", new Date());
            Note note8 = new NoteImpl(4, "TEST", "DEDWARDS", new Date());
            Note note9 = new NoteImpl(5, "TEST", "DEDWARDS", new Date());
            ...
            Element relationship1 = new ElementImpl("APPL", "Applicant", note4, "DEDWARDS", new Date());
            Element relationship2 = new ElementImpl("PTNR", "Patner", note5, "DEDWARDS", new Date());
            Element relationship3 = new ElementImpl("SON", "Son", note6, "DEDWARDS", new Date());
            Element relationship4 = new ElementImpl("DAU", "Daughter", note7, "DEDWARDS", new Date());
