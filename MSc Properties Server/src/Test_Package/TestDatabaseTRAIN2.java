 ...
 * @author Dwayne
 */
public class TestDatabaseTRAIN2 {
    public static void main(String[] args) throws RemoteException {
        ...
        Office office2 = new Office("BHP", address, 0.0, 0.0, new Date(), "DEDWARDS", new Date());
...
//            db.updateEmployee(employee.getEmployeeRef());
            ...
            ex.printStackTrace();
            Logger.getLogger(TestDatabaseTRAIN2.class.getName()).log(Level.SEVERE, null, ex);
        }
        db.disconnect();
    }
}