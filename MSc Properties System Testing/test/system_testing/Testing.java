...
import static server_application.ServerImpl.createServer;
...
public class Testing {
    private ClientImpl dwayne = null;
    private ClientImpl penny = null;
    private ClientImpl sonny = null;
    private ClientImpl test7 = null;
    private ClientImpl test8 = null;
    ...
    public void setUpServer() {
        ServerImpl server = (ServerImpl) createServer(new String[]{"TEST", "127.0.0.1", "root", "", "3306"});
    }
    ...
    @Before
    public void setUpDwayne() {
        try {
            dwayne = (ClientImpl) createClient(new String[]{"127.0.0.1", "TEST", "DEDWARDS", "ToxicTEST"});
    ...
    @After
    public void tearDownDwayne() {
    }
    
    @Before
    public void setUpPenny() {
        try {
            penny = (ClientImpl) createClient(new String[]{"127.0.0.1", "TEST", "PBRINDLE", "PENNYNEW"});
        } catch (RemoteException | NotBoundException | UnknownHostException | MalformedURLException ex) {
            Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    @After
    public void tearDownPenny() {
    }
    
    @Before
    public void setUpSonny() {
        try {
            sonny = (ClientImpl) createClient(new String[]{"127.0.0.1", "TEST", "SDOLAN", "SDOLANpassword"});
        } catch (RemoteException | NotBoundException | UnknownHostException | MalformedURLException ex) {
            Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    @After
    public void tearDownSonny() {
    }
    
    @Before
    public void setUpTest7() {
        try {
            test7 = (ClientImpl) createClient(new String[]{"127.0.0.1", "TEST", "TEST7", "TEST8password"});
        } catch (RemoteException | NotBoundException | UnknownHostException | MalformedURLException ex) {
            Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    @After
    public void tearDownTest7() {
    }
    
    @Before
    public void setUpTest8() {
        try {
            test8 = (ClientImpl) createClient(new String[]{"127.0.0.1", "TEST", "TEST8", "TEST8password"});
        } catch (RemoteException | NotBoundException | UnknownHostException | MalformedURLException ex) {
            Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void testGetOfficeCode() {
        ...
        if (dwayne != null && penny != null && sonny != null) {
            try {
                assertEquals("Dwayne office code must equal MNC", "MNC", dwayne.getOfficeCode());
                assertEquals("Penny office code must equal NEW", "NEW", penny.getOfficeCode());
                assertEquals("Sonny office code must equal MNC", "EDM", sonny.getOfficeCode());
                assertNotSame("Dwayne office code must not equal WRONG", "WRONG", dwayne.getOfficeCode());
                assertNotSame("Penny office code must not equal INCORRECT", "INCORRECT", penny.getOfficeCode());
                assertNotSame("Sonny office code must not equal FAIL", "FAIL", sonny.getOfficeCode());
    ...
    public void testGetUsername() {
        ...
        if (dwayne != null && penny != null && sonny != null) {
            try {
                assertEquals("Dwayne username must equal DEDWARDS", "DEDWARDS", dwayne.getUsername());
                assertEquals("Penny username must equal PBRINDLE", "PBRINDLE", penny.getUsername());
                assertEquals("Sonny username must equal SDOLAN", "SDOLAN", sonny.getUsername());
                assertNotSame("Dwayne username must not equal WRONG", "WRONG", dwayne.getUsername());
                assertNotSame("Penny username must not equal INCORRECT", "INCORRECT", penny.getUsername());
                assertNotSame("Sonny username must not equal FAIL", "FAIL", sonny.getUsername());
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//    }
    ...
    public void testCreateTitle() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createTitle("OTHER", "Other", "test title");
                assertEquals("createTitle return result should equal 1", 1, result);
                int result2 = dwayne.createTitle("OTHER", "Other", "test title");
                assertEquals("createTitle return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateTitle() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updateTitle("OTHER", "Other", true, "test title");
                assertEquals("updateTitle return result should equal 1", 1, result);
                int result2 = dwayne.updateTitle("WRONG", "Other", true, "test title");
                assertEquals("updateTitle return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteTitle() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createTitle("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteTitle("WRONG");
                assertEquals("deleteTitle return result should equal 1", 1, result);
                int result2 = dwayne.deleteTitle("OTHER");
                assertEquals("deleteTitle return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testCreateGender() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createGender("OTHER", "Other", "test title");
                assertEquals("createGender return result should equal 1", 1, result);
                int result2 = dwayne.createGender("OTHER", "Other", "test title");
                assertEquals("createGender return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateGender() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updateGender("OTHER", "Other", true, "test title");
                assertEquals("updateGender return result should equal 1", 1, result);
                int result2 = dwayne.updateGender("WRONG", "Other", true, "test title");
                assertEquals("updateGender return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteGender() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createGender("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteGender("WRONG");
                assertEquals("deleteGender return result should equal 1", 1, result);
                int result2 = dwayne.deleteGender("OTHER");
                assertEquals("deleteGender return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreateMaritalStatus() {
        System.out.println("createMaritalStatus");
        if (dwayne != null) {
            try {
                int result = dwayne.createMaritalStatus("OTHER", "Other", "test title");
                assertEquals("createMaritalStatus return result should equal 1", 1, result);
                int result2 = dwayne.createMaritalStatus("OTHER", "Other", "test title");
                assertEquals("createMaritalStatus return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testUpdateMaritalStatus() {
        System.out.println("updateMaritalStatus");
        if (dwayne != null) {
            try {
                int result = dwayne.updateMaritalStatus("OTHER", "Other", true, "test title");
                assertEquals("updateMaritalStatus return result should equal 1", 1, result);
                int result2 = dwayne.updateMaritalStatus("WRONG", "Other", true, "test title");
                assertEquals("updateMaritalStatus return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testDeleteMaritalStatus() {
        System.out.println("deleteMaritalStatus");
        if (dwayne != null) {
            try {
                dwayne.createMaritalStatus("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteMaritalStatus("WRONG");
                assertEquals("deleteMaritalStatus return result should equal 1", 1, result);
                int result2 = dwayne.deleteMaritalStatus("OTHER");
                assertEquals("deleteMaritalStatus return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreateEthnicOrigin() {
        System.out.println("createEthnicOrigin");
        if (dwayne != null) {
            try {
                int result = dwayne.createEthnicOrigin("OTHER", "Other", "test title");
                assertEquals("createEthnicOrigin return result should equal 1", 1, result);
                int result2 = dwayne.createEthnicOrigin("OTHER", "Other", "test title");
                assertEquals("createEthnicOrigin return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testUpdateEthnicOrigin() {
        System.out.println("updateEthnicOrigin");
        if (dwayne != null) {
            try {
                int result = dwayne.updateEthnicOrigin("OTHER", "Other", true, "test title");
                assertEquals("updateEthnicOrigin return result should equal 1", 1, result);
                int result2 = dwayne.updateEthnicOrigin("WRONG", "Other", true, "test title");
                assertEquals("updateEthnicOrigin return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testDeleteEthnicOrigin() {
        System.out.println("deleteEthnicOrigin");
        if (dwayne != null) {
            try {
                dwayne.createEthnicOrigin("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteEthnicOrigin("WRONG");
                assertEquals("deleteEthnicOrigin return result should equal 1", 1, result);
                int result2 = dwayne.deleteEthnicOrigin("OTHER");
                assertEquals("deleteEthnicOrigin return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testCreateLanguage() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createLanguage("OTHER", "Other", "test title");
                assertEquals("createLanguage return result should equal 1", 1, result);
                int result2 = dwayne.createLanguage("OTHER", "Other", "test title");
                assertEquals("createLanguage return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateLanguage() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updateLanguage("OTHER", "Other", true, "test title");
                assertEquals("updateLanguage return result should equal 1", 1, result);
                int result2 = dwayne.updateLanguage("WRONG", "Other", true, "test title");
                assertEquals("updateLanguage return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteLanguage() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createLanguage("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteLanguage("WRONG");
                assertEquals("deleteLanguage return result should equal 1", 1, result);
                int result2 = dwayne.deleteLanguage("OTHER");
                assertEquals("deleteLanguage return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testCreateNationality() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createNationality("OTHER", "Other", "test title");
                assertEquals("createNationality return result should equal 1", 1, result);
                int result2 = dwayne.createNationality("OTHER", "Other", "test title");
                assertEquals("createNationality return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateNationality() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updateNationality("OTHER", "Other", true, "test title");
                assertEquals("updateNationality return result should equal 1", 1, result);
                int result2 = dwayne.updateNationality("WRONG", "Other", true, "test title");
                assertEquals("updateNationality return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteNationality() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createNationality("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteNationality("WRONG");
                assertEquals("deleteNationality return result should equal 1", 1, result);
                int result2 = dwayne.deleteNationality("OTHER");
                assertEquals("deleteNationality return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreateSexuality() {
        System.out.println("createSexuality");
        if (dwayne != null) {
            try {
                int result = dwayne.createSexuality("OTHER", "Other", "test title");
                assertEquals("createSexuality return result should equal 1", 1, result);
                int result2 = dwayne.createSexuality("OTHER", "Other", "test title");
                assertEquals("createSexuality return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testUpdateSexuality() {
        System.out.println("updateSexuality");
        if (dwayne != null) {
            try {
                int result = dwayne.updateSexuality("OTHER", "Other", true, "test title");
                assertEquals("updateSexuality return result should equal 1", 1, result);
                int result2 = dwayne.updateSexuality("WRONG", "Other", true, "test title");
                assertEquals("updateSexuality return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testDeleteSexuality() {
        System.out.println("deleteSexuality");
        if (dwayne != null) {
            try {
                dwayne.createSexuality("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteSexuality("WRONG");
                assertEquals("deleteSexuality return result should equal 1", 1, result);
                int result2 = dwayne.deleteSexuality("OTHER");
                assertEquals("deleteSexuality return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreateReligion() {
        System.out.println("createReligion");
        if (dwayne != null) {
            try {
                int result = dwayne.createReligion("OTHER", "Other", "test title");
                assertEquals("createReligion return result should equal 1", 1, result);
                int result2 = dwayne.createReligion("OTHER", "Other", "test title");
                assertEquals("createReligion return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testUpdateReligion() {
        System.out.println("updateReligion");
        if (dwayne != null) {
            try {
                int result = dwayne.updateReligion("OTHER", "Other", true, "test title");
                assertEquals("updateReligion return result should equal 1", 1, result);
                int result2 = dwayne.updateReligion("WRONG", "Other", true, "test title");
                assertEquals("updateReligion return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteReligion() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createReligion("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteReligion("WRONG");
                assertEquals("deleteReligion return result should equal 1", 1, result);
                int result2 = dwayne.deleteReligion("OTHER");
                assertEquals("deleteReligion return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testCreatePropertyType() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createPropertyType("OTHER", "Other", "test title");
                assertEquals("createPropertyType return result should equal 1", 1, result);
                int result2 = dwayne.createPropertyType("OTHER", "Other", "test title");
                assertEquals("createPropertyType return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdatePropertyType() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updatePropertyType("OTHER", "Other", true, "test title");
                assertEquals("updatePropertyType return result should equal 1", 1, result);
                int result2 = dwayne.updatePropertyType("WRONG", "Other", true, "test title");
                assertEquals("updatePropertyType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeletePropertyType() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createPropertyType("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deletePropertyType("WRONG");
                assertEquals("deletePropertyType return result should equal 1", 1, result);
                int result2 = dwayne.deletePropertyType("OTHER");
                assertEquals("deletePropertyType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreatePropertySubType() {
        System.out.println("createPropertySubType");
        if (dwayne != null) {
            try {
                int result = dwayne.createPropertySubType("OTHER", "Other", "test title");
                assertEquals("createPropertySubType return result should equal 1", 1, result);
                int result2 = dwayne.createPropertySubType("OTHER", "Other", "test title");
                assertEquals("createPropertySubType return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testUpdatePropertySubType() {
        System.out.println("updatePropertySubType");
        if (dwayne != null) {
            try {
                int result = dwayne.updatePropertySubType("OTHER", "Other", true, "test title");
                assertEquals("updatePropertySubType return result should equal 1", 1, result);
                int result2 = dwayne.updatePropertySubType("WRONG", "Other", true, "test title");
                assertEquals("updatePropertySubType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testDeletePropertySubType() {
        System.out.println("deletePropertySubType");
        if (dwayne != null) {
            try {
                dwayne.createPropertySubType("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deletePropertySubType("WRONG");
                assertEquals("deletePropertySubType return result should equal 1", 1, result);
                int result2 = dwayne.deletePropertySubType("OTHER");
                assertEquals("deletePropertySubType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreatePropertyElement_3args() {
        System.out.println("createPropertyElement - SYSTEM ELEMENT");
        if (dwayne != null) {
            try {
                int result = dwayne.createPropertyElement("OTHER", "Other", "test title");
                assertEquals("createPropertyElement - SYSTEM ELEMENT return result should equal 1", 1, result);
                int result2 = dwayne.createPropertyElement("OTHER", "Other", "test title");
                assertEquals("createPropertyElement - SYSTEM ELEMENT return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testUpdatePropertyElement_4args() {
        System.out.println("updatePropertyElement - SYSTEM ELEMENT");
        if (dwayne != null) {
            try {
                int result = dwayne.updatePropertyElement("OTHER", "Other", true, "test title");
                assertEquals("updatePropertyElement - SYSTEM ELEMENT return result should equal 1", 1, result);
                int result2 = dwayne.updatePropertyElement("WRONG", "Other", true, "test title");
                assertEquals("updatePropertyElement - SYTEM ELEMENT return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//    }
     ...
     */
    @Test
    public void testDeletePropertyElement_String() {
        System.out.println("deletePropertyElement - SYSTEM ELEMENT");
        if (dwayne != null) {
            try {
                dwayne.createPropertyElement("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deletePropertyElement("WRONG");
                assertEquals("deletePropertyElement return result should equal 1", 1, result);
                int result2 = dwayne.deletePropertyElement("OTHER");
                assertEquals("deletePropertyElement return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//    }
    ...
    public void testCreateContactType() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createContactType("OTHER", "Other", "test title");
                assertEquals("createContactType return result should equal 1", 1, result);
                int result2 = dwayne.createContactType("OTHER", "Other", "test title");
                assertEquals("createContactType return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateContactType() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updateContactType("OTHER", "Other", true, "test title");
                assertEquals("updateContactType return result should equal 1", 1, result);
                int result2 = dwayne.updateContactType("WRONG", "Other", true, "test title");
                assertEquals("updateContactType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteContactType() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createContactType("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteContactType("WRONG");
                assertEquals("deleteContactType return result should equal 1", 1, result);
                int result2 = dwayne.deleteContactType("OTHER");
                assertEquals("deleteContactType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreateEndReason() {
        System.out.println("createEndReason");
        if (dwayne != null) {
            try {
                int result = dwayne.createEndReason("OTHER", "Other", "test title");
                assertEquals("createEndReason return result should equal 1", 1, result);
                int result2 = dwayne.createEndReason("OTHER", "Other", "test title");
                assertEquals("createEndReason return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateEndReason() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updateEndReason("OTHER", "Other", true, "test title");
                assertEquals("updateEndReason return result should equal 1", 1, result);
                int result2 = dwayne.updateEndReason("WRONG", "Other", true, "test title");
                assertEquals("updateEndReason return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testDeleteEndReason() {
        System.out.println("deleteEndReason");
        if (dwayne != null) {
            try {
                dwayne.createEndReason("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteEndReason("WRONG");
                assertEquals("deleteEndReason return result should equal 1", 1, result);
                int result2 = dwayne.deleteEndReason("OTHER");
                assertEquals("deleteEndReason return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testCreateRelationship() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createRelationship("OTHER", "Other", "test title");
                assertEquals("createRelationship return result should equal 1", 1, result);
                int result2 = dwayne.createRelationship("OTHER", "Other", "test title");
                assertEquals("createRelationship return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateRelationship() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.updateRelationship("OTHER", "Other", true, "test title");
                assertEquals("updateRelationship return result should equal 1", 1, result);
                int result2 = dwayne.updateRelationship("WRONG", "Other", true, "test title");
                assertEquals("updateRelationship return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteRelationship() {
        ...
        if (dwayne != null) {
            try {
                dwayne.createRelationship("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteRelationship("WRONG");
                assertEquals("deleteRelationship return result should equal 1", 1, result);
                int result2 = dwayne.deleteRelationship("OTHER");
                assertEquals("deleteRelationship return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testCreateAddress() {
        ...
        if (dwayne != null) {
            try {
                int result = dwayne.createAddress("", "", "", "", "10", "Felixstowe Road", "Edmonton", "London", "England", "N9 2RE", "Test address");
                assertTrue("createAddress return result should be greater than 0", result > 0);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testUpdateAddress() {
        ...
        if (dwayne != null) {
            try {
                int addressRef = dwayne.createAddress("TEST", "TEST", "TEST", "TEST", "10", "Felixstowe Road", "Edmonton", "London", "England", "N9 2RE", "Test address");
                int result = dwayne.updateAddress(addressRef, "AMENDED", "AMENDED", "AMENDED", "AMENDED", "10", "Felixstowe Road", "Edmonton", "London", "England", "N9 2RE", "Test address");
                assertTrue("updateAddress return result should be greater than 0", result > 0);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeleteAddress() {
        ...
        if (dwayne != null) {
            try {
                int addressRef = dwayne.createAddress("NEW TEST", "NEW TEST", "NEW TEST", "NEW TEST", "10", "Felixstowe Road", "Edmonton", "London", "England", "N9 2RE", "Test address");
                int addressRef1 = dwayne.createAddress("NEW TEST", "NEW TEST", "NEW TEST", "NEW TEST", "20", "Felixstowe Road", "Edmonton", "London", "England", "N9 2RE", "Test address");
                dwayne.updateAddress(addressRef1, "AMENDED", "AMENDED", "AMENDED", "AMENDED", "10", "Felixstowe Road", "Edmonton", "London", "England", "N9 2RE", "Test address");
                int result = dwayne.deleteAddress(addressRef);
                int result2 = dwayne.deleteAddress(addressRef1);
                assertTrue("deleteAddress return result be greater than 0", result > 0);
                assertTrue("deleteAddress return2 should be less than 1", result2 < 1);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreatePerson_15args() {
        System.out.println("createPerson - WITH ADDRESS");
        if (dwayne != null) {
            try {
                Calendar dob = Calendar.getInstance();
                dob.set(1989, 9, 3);
                int result = dwayne.createPerson("MR", "TEST10", "TEST10", "TEST10", dob.getTime(), "TEST10", "M", "SNGL", "GBR", "ENGL", "SNGL", "STR", "PNTS", 1, new Date());
                assertTrue("createPerson return result should be greater than 0", result > 0);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreatePerson_13args() {
        System.out.println("createPerson - NO ADDRESS");
        if (dwayne != null) {
            try {
                Calendar dob = Calendar.getInstance();
                dob.set(1989, 9, 3);
                int result = dwayne.createPerson("MR", "TEST11", "TEST11", "TEST11", dob.getTime(), "TEST11", "M", "SNGL", "GBR", "ENGL", "SNGL", "STR", "PNTS");
                assertTrue("createPerson return result should be greater than 0", result > 0);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public void testUpdatePerson() {
        ...
        if (dwayne != null) {
            try {
                Calendar dob = Calendar.getInstance();
                dob.set(1989, 9, 3);
                int personRef = dwayne.createPerson("MR", "TEST12", "TEST12", "TEST12", dob.getTime(), "TEST12", "M", "SNGL", "GBR", "ENGL", "SNGL", "STR", "PNTS");
                int result = dwayne.updatePerson(personRef, "MR", "TEST12-AMENDED", "TEST12-AMENDED", "TEST12-AMENDED", dob.getTime(), "TEST12-AMENDED", "M", "SNGL", "GBR", "ENGL", "SNGL", "STR", "PNTS");
                assertTrue("updatePerson return result should be greater than 0", result > 0);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    public void testDeletePerson() {
        ...
        if (dwayne != null) {
            try {
                Calendar dob = Calendar.getInstance();
                dob.set(1989, 9, 3);
                int personRef = dwayne.createPerson("MR", "TEST13", "TEST13", "TEST13", dob.getTime(), "TEST13", "M", "SNGL", "GBR", "ENGL", "SNGL", "STR", "PNTS");
                int personRef1 = dwayne.createPerson("MR", "TEST14", "TEST14", "TEST14", dob.getTime(), "TEST14", "M", "SNGL", "GBR", "ENGL", "SNGL", "STR", "PNTS");
                dwayne.updatePerson(personRef, "MR", "TEST13-AMENDED", "TEST13-AMENDED", "TEST13-AMENDED", dob.getTime(), "TEST13-AMENDED", "M", "SNGL", "GBR", "ENGL", "SNGL", "STR", "PNTS");
                int result = dwayne.deletePerson(personRef1);
                int result2 = dwayne.deletePerson(personRef);
                assertTrue("deletePerson return result be greater than 0", result > 0);
                assertTrue("deletePerson return2 should be less than 1", result2 < 1);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testCreatePersonNote() {
     ...
     */
    @Test
    public void testCreateTenancyType() {
        System.out.println("createTenancyType");
        if (dwayne != null) {
            try {
                int result = dwayne.createTenancyType("OTHER", "Other", "test title");
                assertEquals("createTenancyType return result should equal 1", 1, result);
                int result2 = dwayne.createTenancyType("OTHER", "Other", "test title");
                assertEquals("createTenancyType return result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testUpdateTenancyType() {
        System.out.println("updateTenancyType");
        if (dwayne != null) {
            try {
                int result = dwayne.updateTenancyType("OTHER", "Other", true, "test title");
                assertEquals("updateTenancyType return result should equal 1", 1, result);
                int result2 = dwayne.updateTenancyType("WRONG", "Other", true, "test title");
                assertEquals("updateTenancyType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
     ...
     */
    @Test
    public void testDeleteTenancyType() {
        System.out.println("deleteTenancyType");
        if (dwayne != null) {
            try {
                dwayne.createTenancyType("WRONG", "Wrong", "going to be deleted");
                int result = dwayne.deleteTenancyType("WRONG");
                assertEquals("deleteTenancyType return result should equal 1", 1, result);
                int result2 = dwayne.deleteTenancyType("OTHER");
                assertEquals("deleteTenancyType return2 result should equal 0", 0, result2);
            } catch (RemoteException ex) {
                Logger.getLogger(Testing.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
