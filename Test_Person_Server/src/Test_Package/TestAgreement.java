...
public class TestAgreement {
    public static void main(String[] args) {
        ...
        Agreement test1 = new Agreement(1, new Date(), 12, "DEDWARDS1");
        System.out.println("test 1 - 12 months");
        
        Agreement test2 = new Agreement(1, new Date(), -15, "DEDWARDS2");
        System.out.println("test 2 - subtract 15 months");
        
        Agreement test3 = new Agreement(1, new Date(), 6, "DEDWARDS3");
        System.out.println("test 3 - 6 months");
        
        Agreement test4 = new Agreement(1, new Date(), 26, "DEDWARDS4");
