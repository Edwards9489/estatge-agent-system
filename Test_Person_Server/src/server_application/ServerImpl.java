...
public class ServerImpl extends UnicastRemoteObject implements Server {
    ...
    public int createApplication(ArrayList<InvolvedPartyInterface> household, AddressUsageInterface address, String corrName, String createdBy) {
        Application a = new Application(appRef, household, address, corrName, createdBy);
        appRef++;
