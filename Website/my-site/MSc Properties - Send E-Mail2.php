...
<div id="email">
	...
	<?php
		...
		else
		{
			...
			$subject = $firstname." ".$lastname." LETTING INTEREST";
			
			$message = $firstname." ".$lastname." showed an interest in Letting<br><br>";
			$message .= "E-Mail: ".$email."<br>";
			$message .= "Tel: ".$phone."<br>";
			$message .= "Kitchen: ".$kitchen."<br>";
			$message .= "Prop Type: ".$type."<br>";
			$message .= "Prop Sub Type: ".$sub_type."<br>";
			$message .= "Prop Age: ".$age."<br>";
			$message .= "Bedrooms: ".$beds."<br>";
			$message .= "Driveway: ".$driveway."<br>";
			$message .= "Garden: ".$garden."<br>";
			$message .= "Conservatory: ".$conservatory."<br>";
			$message .= "Bathrooms: ".$baths."<br>";
			$message .= "Receptions: ".$receptions."<br>";
			...
			$mail->AddAddress('dwayne.edwards9489@outlook.com', 'Letting'); /* ... */
